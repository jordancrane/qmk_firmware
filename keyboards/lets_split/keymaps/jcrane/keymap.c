...
[_LOWER] = LAYOUT_ortho_4x12( \
  _______, KC_HASH, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, _______, KC_P7,    KC_P8,   KC_P9,   KC_PAST, _______, \
  KC_AMPR, KC_CIRC, KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV,  _______, KC_P4,    KC_P5,   KC_P6,   KC_PMNS, KC_PSLS, \
  _______, KC_PERC, KC_EXLM, KC_LBRC, KC_RBRC, KC_TILD, _______, KC_P1,    KC_P2,   KC_P3,   KC_PPLS, _______, \
